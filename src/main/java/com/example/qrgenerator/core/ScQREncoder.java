...
public final class ScQREncoder {
     ...
     *                         or configuration
     */
    public static QRCode encode(String content, ErrorCorrectionLevel ecLevel, int[] keyArr) throws WriterException {
        return encode(content, ecLevel, keyArr, null);
    }
    ...
    public static QRCode encode(String content,
        ...
        MatrixUtil.buildMatrixWithKey(finalBits, ecLevel, version, maskPattern, matrix, keyArr);
